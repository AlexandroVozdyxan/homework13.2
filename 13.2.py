class Counter:
   ...
   def set_current(self, start):
       if start < self.min_value or start > self.max_value:
           raise ValueError("Star value need to be in range min and max")
       self.current = start
   ...
   def set_min(self, min_min):
       if min_min > self.max_value:
           raise ValueError("Min value cannot be higher than max")
   ...
   def step_up(self):
       if self.current >= self.max_value:
           raise ValueError("Current value is max")
       self.current += 1

   def step_down(self):
       if self.current <= self.min_value:
           raise ValueError("Current value is min")
       self.current -= 1
